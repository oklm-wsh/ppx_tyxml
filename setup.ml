...
(* OASIS_START *)
(* DO NOT EDIT (digest: ae529db14c14eb0fa874b151719329ae) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Eyy\195\188b SARI (Shab Team)"];
          homepage = None;
          synopsis =
            "Take a .html or .svg file and output a .ml file containing a\nTyXML tree.";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bin/main.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\203c\139\186ZM\138\161\133\029\240\203\200\228\214\184";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
